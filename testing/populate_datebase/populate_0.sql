...
CREATE UNIQUE INDEX APP.reg_id_pk
ON APP.regions (region_id);

ALTER TABLE APP.regions
...
CREATE UNIQUE INDEX APP.loc_id_pk
ON APP.locations (location_id) ;
...
ADD ( CONSTRAINT loc_id_pk
    ...
    , CONSTRAINT loc_c_id_fk
        	  ...
        	  REFERENCES APP.countries(country_id) 
    ) ;


REM ********************************************************************

CREATE SEQUENCE APP.locations_seq
 START WITH     3300
 INCREMENT BY   100
 MAXVALUE       9900
 NOCACHE
...
REM ********************************************************************
 ...
 CREATE TABLE APP.departments
    ...
    CREATE UNIQUE INDEX APP.dept_id_pk
ON APP.departments (department_id) ;
...
ADD ( CONSTRAINT dept_id_pk
    ...
    , CONSTRAINT dept_loc_fk
        	  ...
        	  REFERENCES APP.locations (location_id)
     ) ;

CREATE SEQUENCE APP.departments_seq
 START WITH     280
 INCREMENT BY   10
 MAXVALUE       9990
 NOCACHE
...
CREATE UNIQUE INDEX APP.job_id_pk 
ON APP.jobs (job_id) ;
...
CREATE UNIQUE INDEX APP.emp_emp_id_pk
ON APP.employees (employee_id) ;
...
ADD ( CONSTRAINT     emp_emp_id_pk
    ...
    , CONSTRAINT     emp_dept_fk
                     FOREIGN KEY (department_id)
                      REFERENCES APP.departments
    , CONSTRAINT     emp_job_fk
                     FOREIGN KEY (job_id)
                      REFERENCES APP.jobs (job_id)
    , CONSTRAINT     emp_manager_fk
                     FOREIGN KEY (manager_id)
                      REFERENCES APP.employees
    ) ;
...
CREATE SEQUENCE APP.employees_seq
 START WITH     207
 INCREMENT BY   1
 NOCACHE
 NOCYCLE;
...
CREATE UNIQUE INDEX APP.jhist_emp_id_st_date_pk 
ON APP.job_history (employee_id, start_date) ;

--ALTER TABLE APP.job_history
...
REM ********************************************************************
 ...
 CREATE OR REPLACE VIEW APP.emp_details_view
  (employee_id,
   job_id,
   manager_id,
   department_id,
...
INSERT INTO APP.regions VALUES 
        ( 1
        , 'Europe' 
        );
...
REM ***************************insert data into the APP.countries table

Prompt ******  Populating COUNTIRES table ....

INSERT INTO APP.countries VALUES 
        ( 'IT'
        , 'Italy'
        , 1 
        );
...
REM ***************************insert data into the APP.locations table

Prompt ******  Populating APP.locations table ....

INSERT INTO APP.locations VALUES 
        ( 1000 
...
REM ****************************insert data into the APP.departments table

Prompt ******  Populating APP.departments table ....

REM disable integrity constraint to APP.employees to load data
...
REM ***************************insert data into the APP.employees table

Prompt ******  Populating APP.employees table ....

...
public class OracleDataCatalogOMRSRepositoryConnector
    ...
    private GenericDataCatalogClient genericDataCatalogClient = null;
    private String catalogId = null;
    
    private static GenericDataCatalogClient createGenericDataCatalogClient(
            final Map<String, Object> configurationProperties) {
        if (configurationProperties == null) {
            LOGGER.warn(
                    "ConfigurationProperties to create DataCatalogClient are missing.");
            return null;
        }
        final String region = (String) configurationProperties.get("region");
        ...
        final String fingerprint = (String) configurationProperties.get(
                "fingerprint");
        final String catalogId = (String) configurationProperties.get("catalog_id");

        if ((region == null) || (apiKey == null) || (tenancy == null)
                || (user == null) || (fingerprint == null) || (catalogId == null)) {
        ...
        AuthenticationDetailsProvider provider
                = SimpleAuthenticationDetailsProvider.builder()
                        ...
                        .build();
        return new GenericDataCatalogClient(region, tenancy, user, fingerprint, apiKey, catalogId);
    }
    ...
    public void initialize(
        ...
        LOGGER.debug("initialize({}, {})", connectorInstanceId,
                connectionProperties);
        super.initialize(connectorInstanceId, connectionProperties);

        dataCatalogClient = createDataCatalogClient(
                connectionProperties.getConfigurationProperties());
        genericDataCatalogClient = createGenericDataCatalogClient(
                connectionProperties.getConfigurationProperties());
        if (connectionProperties.getConfigurationProperties() != null) {
            catalogId = (String) connectionProperties
                    .getConfigurationProperties().get("catalog_id");
        }
    }

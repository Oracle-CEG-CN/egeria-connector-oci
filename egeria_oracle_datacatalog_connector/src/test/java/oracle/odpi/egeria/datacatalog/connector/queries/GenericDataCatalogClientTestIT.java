 ...
 *
 */
public class GenericDataCatalogClientTestIT {
    ...
    public void setUp() throws Exception {
        final ConfigFileReader.ConfigFile configuration = ConfigFileReader
                .parseDefault();
        ...
        final String key = Files.lines(Paths.get(
                "/home/stefan/.oci/oci_api_key.pem")).collect(Collectors
                        .joining("\n"));

        client = new GenericDataCatalogClient(region, tenancy, user, fingerprint,
                key, CATALOG_ID);
    }

    @Test
    public void testQueryCatalog() {
        JsonNode result = client.queryCatalog("dataAssets/%s",
                new Object[]{"fd732d11-80e5-4f1b-8288-9102e147151d"});
